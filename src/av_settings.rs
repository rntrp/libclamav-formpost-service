...
pub struct AvSettingsBuilder {
    current: cl_scan_options,
}

impl AvSettingsBuilder {
    pub fn new() -> Self {
        AvSettingsBuilder {
    ...
    pub fn block_encrypted(&mut self) -> &mut Self {
        self.current.heuristic |=
            CL_SCAN_HEURISTIC_ENCRYPTED_ARCHIVE | CL_SCAN_HEURISTIC_ENCRYPTED_ARCHIVE;
        self
    }
